...
export function BucketList (): JSX.Element {
  const entries = [
    ['my fun file.txt', 'bafybeifejmdbliebpx2cecepy26peiesiqgozt7k52kwnixa4zhecuccma'],
    ['some/textdirectory', 'bafybeifejmdbliebpx2cecepy26peiesiqgozt7k52kwnixa4zhecuccma'],
    ['moar.pdf', 'bafybeifejmdbliebpx2cecepy26peiesiqgozt7k52kwnixa4zhecuccma'],
    ['testymctestface/1.doc', 'bafybeifejmdbliebpx2cecepy26peiesiqgozt7k52kwnixa4zhecuccma'],
    ['guardian.jpg', 'bafybeifejmdbliebpx2cecepy26peiesiqgozt7k52kwnixa4zhecuccma'],
  ]
  const loading = false
