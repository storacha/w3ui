...
export default function Authenticator ({ children }) {
  ...
  if (authStatus === AuthStatus.EmailVerification) {
    return (
      <div>
        <h1 className='light-silver'>Verify your email address!</h1>
        <p className='near-white'>Click the link in the email we sent to {identity && identity.email} to sign in.</p>
